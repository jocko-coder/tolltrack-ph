...
async function main() {
  ...
  {
    const { CSS_UI, masterSplashA, masterSplashC, masterDashA, masterDashC, masterListC } = require('./masterUI');
    const plates = [
      { name: 'plate-splash-a', body: masterSplashA(), h: 932, dpr: 8 },
      { name: 'plate-splash-c', body: masterSplashC(), h: 932, dpr: 8 },
      { name: 'plate-dash-a', body: masterDashA(), h: 1150, dpr: 6 },
      { name: 'plate-dash-c', body: masterDashC(), h: 1130, dpr: 6 },
      { name: 'plate-list-c', body: masterListC(), h: 1080, dpr: 7 },
    ];
